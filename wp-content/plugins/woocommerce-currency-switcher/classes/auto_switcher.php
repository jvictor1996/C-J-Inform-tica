...
final class WOOCS_AUTO_SWITCHER {
    ...
    public function wp_head() {
        ...
        if ($this->show) {
            wp_enqueue_style('woocs-auto-switcher', WOOCS_LINK . 'css/auto_switcher/' . $this->data['skin'] . '.css');
            if ($this->data['skin'] == 'round_select') {
                wp_enqueue_script('woocs-round_select', WOOCS_LINK . 'js/auto_switcher/round_select.js');
            }
        }
    }
