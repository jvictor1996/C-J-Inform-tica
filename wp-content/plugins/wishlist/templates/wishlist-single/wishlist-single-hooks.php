...
function wishlist_single_title_display(){
	...
	include (PICKPLUGINS_WISHLIST_PLUGIN_DIR.'templates/wishlist-single/title.php');
}

function wishlist_bredcrumb_display(){

    include (PICKPLUGINS_WISHLIST_PLUGIN_DIR.'templates/wishlist-single/breadcrumb.php');
}
function wishlist_content_display(){

	include (PICKPLUGINS_WISHLIST_PLUGIN_DIR.'templates/wishlist-single/content.php');
}


function wishlist_tags_display(){

	include (PICKPLUGINS_WISHLIST_PLUGIN_DIR.'templates/wishlist-single/tags.php');
}


function wishlist_editing_display(){

	include (PICKPLUGINS_WISHLIST_PLUGIN_DIR.'templates/wishlist-single/editing.php');
}


function wishlist_meta_display(){

	include (PICKPLUGINS_WISHLIST_PLUGIN_DIR.'templates/wishlist-single/meta.php');
}


function wishlist_delete_form_display(){

	include (PICKPLUGINS_WISHLIST_PLUGIN_DIR.'templates/wishlist-single/delete-form.php');
}

function wishlist_edit_form_display(){

	include (PICKPLUGINS_WISHLIST_PLUGIN_DIR.'templates/wishlist-single/edit-form.php');
}


function wishlist_items_display(){

	include (PICKPLUGINS_WISHLIST_PLUGIN_DIR.'templates/wishlist-single/items.php');
}
