...
<?php if ( $wishlisted_items && $total_items > 0  ) : ?>
    ...
    <p class='pick_notice pick_success'><?php echo sprintf( __("%s Item showing out of %s Items", 'woo-wishlist' ), "<strong>".count($wishlisted_items)."</strong>", "<strong>$total_items</strong>" ); ?></p>
...
<?php else : ?>
    ...
    <p class='pick_notice pick_warning'><?php echo __( 'Sorry, No items found !', 'woo-wishlist' ); ?></p>
