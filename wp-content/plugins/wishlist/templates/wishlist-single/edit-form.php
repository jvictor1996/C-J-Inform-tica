...
<div class="pickplugins_wl_popup_container pickplugins_wl_popup_edit" wishlist_id="<?php echo $wishlist_id; ?>">
    <div class="pickplugins_wl_popup_box">
        ...
        <h2 class="pickplugins_wl_popup_title"><?php echo __('Edit', 'woo-wishlist')." <i>". get_the_title( $wishlist_id )."</i>"; ?></h2>

        <p class='pick_notice'></p>

        <div class='pickplugins_wl_popup_section'>
            <h5 class="pickplugins_wl_popup_section_title"><?php echo __('Title', 'woo-wishlist'); ?></h5>
            <input type="text" class="pickplugins_wl_wishlist_title" value="<?php echo get_the_title( $wishlist_id ); ?>" />
        </div>

        <div class='pickplugins_wl_popup_section'>
            <h5 class="pickplugins_wl_popup_section_title"><?php echo __('Short Description', 'woo-wishlist'); ?></h5>
            <textarea type="text" class="pickplugins_wl_wishlist_sd" rows="5" cols="40"><?php echo get_the_content(); ?></textarea>
        </div>

        <div class='pickplugins_wl_popup_section'>
            <h5 class="pickplugins_wl_popup_section_title"><?php echo __('Wishlist Status', 'woo-wishlist'); ?></h5>
		...
		<?php if( get_option( 'pickplugins_wl_enable_tags' ) != 'no' ) : ?>
            <div class='pickplugins_wl_popup_section'>
                <h5 class="pickplugins_wl_popup_section_title"><?php echo __('Tags - Comma separated', 'woo-wishlist'); ?></h5>
                <input type="text" class="pickplugins_wl_wishlist_tags" value="<?php echo implode( ",",$pickplugins_wl_wishlist_tags); ?>" />
            </div>
		<?php endif; ?>

        <div class="pickplugins_wl_popup_btn pickplugins_wl_popup_cancel"><i class="fa fa-times" aria-hidden="true"></i> <?php echo __("Cancel", 'woo-wishlist' ); ?></div>
        <div class="pickplugins_wl_popup_btn pickplugins_wl_popup_save"><i class="fa fa-check" aria-hidden="true"></i> <?php echo __("Save Changes", 'woo-wishlist' ); ?></div>
