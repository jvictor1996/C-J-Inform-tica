...
<div class="pickplugins_wl_wishlist_buttons" style="font-size:<?php echo $button_font_size; ?>px" item_id="<?php echo $item_id; ?>">
	...
	if( $wishlisted_array ) { 
		...
		$hint_text 	= apply_filters( "pickplugins_wl_filter_wishlist_save_icon_hint_text", __( 'Add to Favourites', 'woo-wishlist' ), $item_id );
	...
	<div class="pickplugins_wl_wishlist_save hint--top not-logged-in" aria-label="<?php echo apply_filters( 'pickplugins_wl_filter_wishlist_save_icon_not_logged_in_hint_text', __( 'Please Login', 'woo-wishlist' ) ); ?>"><span class="pickplugins_wl_wishlist_save_icon"><i class='fa fa-heart' aria-hidden='true'></i></span></div>
