...
class PickpluginsWishList{
	...
	public function loading_functions() {
		...
		require_once( PICKPLUGINS_WISHLIST_PLUGIN_DIR . 'includes/functions-ajax.php');
		require_once( PICKPLUGINS_WISHLIST_PLUGIN_DIR . 'includes/functions-settings.php');

		require_once( PICKPLUGINS_WISHLIST_PLUGIN_DIR . 'templates/wishlist-single/wishlist-single-hooks.php');
	...
	public function declare_classes() {
		...
		require_once( PICKPLUGINS_WISHLIST_PLUGIN_DIR . 'includes/classes/class-column-wishlist.php');	
	}
