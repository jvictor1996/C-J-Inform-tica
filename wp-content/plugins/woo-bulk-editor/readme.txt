...
WordPress plugin for managing and bulk edit woocommerce products data in the robust and flexible way!

== Description ==

WooCommerce Bulk Editor - WOOBE – WordPress plugin for managing and bulk edit woocommerce products data in the robust and flexible way! Be professionals with managing data of your woocommerce e-shop!

Latest PHP 7.2.x - FULL COMPATIBILITY! WooCommerce compatibility: from v.3.3.1 to the latest version
...
= 1.0.1 =
* https://bulk-editor.com/update-2-0-1/
